...
|------|------|
| リリース tag | `v1.0.2` |
| sayane version | `1.0.2` |
| pytest 結果 | **171 passed**, 0 failed, 1 warning（2026-05-30） |
| L2 実施日 | **2026-05-29**（PRE-M01 / SERVE-M01 / STOR-M02）— 1.0.1 から変更なし |
| L3 実施日（該当時） | **2026-05-30** — Playwright E2E: INS-CG-02 / INS-CL-02 / INS-CG-04 **P**（§6.1） |
| 判定 | ☑ **Pass** / ☐ Fail |
| 実施環境 | macOS · Python 3.11 · Extension 0.3.5 |
| 備考 | provider registry · Gemini/DeepSeek adapter · CLI capture · sayane-pro 併用 pytest OK |
