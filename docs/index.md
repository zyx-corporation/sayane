...
- [Rust 境界設計（Phase 6）](rust-boundary.md)
- [Dogfood 手順書（エンドツーエンド）](dogfood-walkthrough.md)
- [商用版（Commercial Edition / sayane-pro）](https://github.com/zyx-corporation/sayane-pro/blob/main/docs/commercial-edition.md) — backend 選択、移行 CLI、暗号化 SQLite、Windows MSI
