...
2026-05 以降、プロジェクト名・リポジトリ名・CLI を **Sayane（紗綾音）** に統一した。Community Edition **1.0.0** 以降は新名称のみをサポートする。
...
現時点では **PyPI 公開パッケージ名 `sayane` は未提供**。インストールは [install.sh](../scripts/install.sh) / [install.ps1](../scripts/install.ps1) または `pip install git+https://github.com/zyx-corporation/sayane.git@v1.0.0` を利用する。

## 関連

- [CHANGELOG](../CHANGELOG.md) — 0.6.0 リネームと 1.0.0 リリース情報
