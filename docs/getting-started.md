...
**未実装（Phase 6 / Commercial Edition）**: [omomuki-pro](https://github.com/zyx-corporation/omomuki-pro/blob/main/docs/commercial-edition.md) を参照。
...
または `OMOMUKI_SOURCE_DIR=$PWD bash scripts/install.sh`
