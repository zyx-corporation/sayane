...
from sayane.storage.backends import filesystem as filesystem_backend
from sayane.storage.base import StorageBackendError, StorageBundle
from sayane.storage.config import StorageConfig
...
def _discover_entry_points() -> None:
    try:
        eps = entry_points(group="sayane.storage_backends")
    except TypeError:
        eps = entry_points().get("sayane.storage_backends", ())
    for ep in eps:
