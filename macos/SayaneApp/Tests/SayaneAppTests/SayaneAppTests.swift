...
@Test func appStringsLocalizeSummaryCardLabels() {
    ...
    #expect(strings.summaryCardLabel("vault_status") == "Vault 状態")
    #expect(strings.summaryCardLabel("vault_backend") == "Vault backend")
    ...
    #expect(strings.tokenLabel("sqlite_test_local_vault") == "SQLite test local vault")
    #expect(strings.tokenLabel("sqlite_development_local_vault") == "SQLite development local vault")
    ...
    #expect(strings.tokenLabel("vault_unavailable") == "Vault 未接続")
    ...
    #expect(strings.text(.vaultPath) == "Vault パス")
    #expect(strings.text(.vaultSessions) == "Unlock session")
    ...
    #expect(strings.text(.lockAll) == "すべて lock")
    #expect(strings.text(.unlockPolicies) == "Unlock policy")
    #expect(strings.text(.recommendedSetup) == "推奨セットアップ")
    #expect(strings.text(.supported) == "対応")
    #expect(strings.text(.notSupported) == "未対応")
    #expect(strings.text(.vaultUnavailable) == "Local Vault はまだ常用 runtime に接続されていません")
    ...
    #expect(strings.text(.allowedControlExposure) == "許可Control Exposure")
    ...
    #expect(strings.vaultSessionOpenedMessage(level: "sensitive") == "unlock session を開始: 要保護")
    #expect(strings.vaultSessionsLockedMessage() == "unlock session を lock しました")
    ...
    #expect(strings.tokenLabel("local_bridge_shell_primary") == "Local Bridge shell")
