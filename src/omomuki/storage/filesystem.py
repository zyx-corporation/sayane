...
from omomuki.core.loader import load_profile, save_profile
...
class FileSystemProfileStore:
    """Profile store rooted at a directory containing omomuki.profile.yaml."""

    def __init__(self, profile_dir: Path, profile_filename: str = "omomuki.profile.yaml") -> None:
