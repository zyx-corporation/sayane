...
**現行リポジトリ版**: Community Edition **v1.0.13**

**PyPI 公開版**: Community Edition **v1.0.13**
...
```bash
SAYANE_REF=v1.0.13 curl -fsSL https://raw.githubusercontent.com/zyx-corporation/sayane/main/scripts/install.sh | bash
```
...
Community Edition **v1.0.13** では、以下が利用可能です。
