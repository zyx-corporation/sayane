...
- [商用版（Commercial Edition / sayane-pro）](https://github.com/zyx-corporation/sayane-pro/blob/main/docs/commercial-edition.md) — backend 選択、移行 CLI、暗号化 SQLite、MSI、[Rust 境界設計](https://github.com/zyx-corporation/sayane-pro/blob/main/docs/rust-boundary.md)
