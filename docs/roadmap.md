...
Community Edition（Apache 2.0）は FileSystem + Git + Python Core を **継続メンテ** する。Rust/SQLite backend・移行 CLI・MSI の実装本体は [sayane-pro](https://github.com/zyx-corporation/sayane-pro) とし、Storage 抽象の契約のみ OSS に残す。
