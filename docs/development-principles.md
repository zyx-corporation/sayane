...
FileSystem、Obsidian、Git、**Commercial Edition（Rust 暗号化 SQLite）** を差し替え可能にする。商用版の設計・ライセンス保護対象は [sayane-pro](https://github.com/zyx-corporation/sayane-pro/blob/main/docs/commercial-edition.md) を参照。
