...
| 項目 | 値 |
|------|-----|
| **Omomuki** | **0.5.8** 以降（`omomuki --version`） |
...
| Omomuki | `pip install -e ".[dev]"` 済み、`omomuki --version` → `omomuki 0.5.8` |
...
| PRE-05 | Extension が Chrome に読み込まれている | 拡張機能一覧に Omomuki **0.3.2** | | |
