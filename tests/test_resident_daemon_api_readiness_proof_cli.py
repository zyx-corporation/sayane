"""Tests for resident daemon API-readiness proof CLI."""
...
def test_daemon_api_readiness_proof_json_uses_default_runtime_root(
    isolated_home: Path,
    app: typer.Typer,
) -> None:
...
def test_daemon_api_readiness_proof_json_accepts_operation_class(
    isolated_home: Path,
    app: typer.Typer,
) -> None:
