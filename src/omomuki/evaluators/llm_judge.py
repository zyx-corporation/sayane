...
from omomuki.core.candidate import CandidateProposal, LLMReview, RDEClass, UIBScores
...
_JUDGE_PROMPT = """You are an RDE reviewer for Omomuki profile updates.
...
def _profile_summary(profile: OmomukiProfile) -> str:
