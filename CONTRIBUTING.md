...
Omomukiでは、変更を単なる機能追加ではなく、意味変化として扱います。
...
Omomukiは、LLM差異、UI差異、Storage差異、評価差異を扱うため、設計パターンを明示的に重視します。
...
#10 OmomukiProfile schema and Pydantic model
