...
| **関連 Issue** | [#78](https://github.com/zyx-corporation/sayane/issues/78) OSS 契約維持 · [#88](https://github.com/zyx-corporation/sayane/issues/88) L2 Core 手動 · [#89](https://github.com/zyx-corporation/sayane/issues/89) L3 Extension UAT · [#92](https://github.com/zyx-corporation/sayane/issues/92) L1 pytest（完了） · [#91](https://github.com/zyx-corporation/sayane/issues/91) Extension E2E（完了） · [#93](https://github.com/zyx-corporation/sayane/issues/93) [手動のみ](acceptance-manual-only.md) · [#96](https://github.com/zyx-corporation/sayane/issues/96) provider registry（main `8f2b558` merge） · [#83](https://github.com/zyx-corporation/sayane/issues/83) WinGet/Scoop draft（merge 済・Issue close 待ち） |
...
|------|------|
| リリース tag | `v1.0.1` |
| sayane version | `1.0.1` |
| pytest 結果 | **164 passed**, 0 failed, 1 warning（専用 venv・sayane-pro 未インストール・2026-05-29） |
| L2 実施日 | **2026-05-29**（PRE-M01 / SERVE-M01 / STOR-M02） |
| L3 実施日（該当時） | **2026-05-30** — Playwright E2E: INS-CG-02 / INS-CL-02 / INS-CG-04 **P**（§6.1）。popup toolbar 2件 **S** |
| 判定 | ☑ **Pass** / ☐ Fail |
| 実施環境 | macOS · Python 3.11 · `pip install -e ".[dev]"`（`/tmp/sayane-release-venv`） |
| 備考 | `ruff check src tests` pass · GitHub Release `v1.0.1` · Extension provider registry @ `8f2b558` · sayane-pro 併用 pytest 6 passed（2026-05-30） |
