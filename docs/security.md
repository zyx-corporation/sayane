...
Commercial Edition では **機密データ基準・許容範囲の登録** と **逸脱監査** を sayane-pro で提供する（[confidentiality-audit.md](https://github.com/zyx-corporation/sayane-pro/blob/main/docs/confidentiality-audit.md)）。RDE（意味変化）と相互補完する。
...
Commercial Edition では、機密区分・セクション許容範囲の登録と逸脱監査を [sayane-pro](https://github.com/zyx-corporation/sayane-pro/blob/main/docs/confidentiality-audit.md) で行う。
