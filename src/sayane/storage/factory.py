...
from sayane.cli.paths import resolve_profile_path, sayane_home
from sayane.storage.base import StorageBackendError, StorageBundle
from sayane.storage.config import (
    StorageConfig,
    load_storage_config,
    profile_dir_for_id,
    save_storage_config,
)
from sayane.storage.registry import get_backend_factory, list_backends, open_backend
...
def open_storage(
    *,
    ...
    resolved_home = home or sayane_home()
